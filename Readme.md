...
```
var Babbler = require('atropa-Babbler').Babbler;
console.log(Babbler);
```

In the browser this module is attached to the global namespace `atropa`, which
 will be created if it does not exist.
 Include `./browser/atropa-Babbler_web.js` in your page and
 `atropa.Babbler` will be available in your page.
...
To run the browser tests open `browser/atropa-Babbler_tests.html` in your
...
If you alter the source in `src/atropa-Babbler.js` please run the
